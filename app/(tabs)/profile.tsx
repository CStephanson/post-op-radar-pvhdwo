...
export default function ProfileScreen() {
  ...
  const loadProfile = async () => {
    ...
    try {
      ...
      // If profile doesn't exist, that's okay - user might need to create it
  ...
  const handleEditProfile = async () => {
    ...
    // If profile exists, we need to update it, so pre-populate the form
    // For now, just navigate to profile-setup which will handle both create and update
